// https://www.svgrepo.com/svg/489804/trash
export const BinButton = ({...rest}: any) => (
	<svg data-testid={`components-icon-BinButton`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
